...
const float BLOOM_STRENGTH = 0.1; // Controls the intensity of the added glow.
const float BLOOM_THRESHOLD = 0.01; // Sets the luminance at the center of the bloom transition.
const float BLOOM_SOFT_KNEE = 0.05; // Sets the transition width on each side of the threshold.

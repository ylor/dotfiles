...
if string match -q "*’s*" $computer_name; and gum confirm "Change computer name? Current: $computer_name"
    set -l new_name (gum input --prompt "New computer name: " --placeholder $computer_name)
    if test -n "$new_name"

...
--[[
    ...
    Source: https://gist.github.com/maxandersen/d09ebef333b0c7b7f947420e2a7bbbf5
...
obj.keywords = {
    nname = "Max Rydahl Andersen",
    lloll = hs.base64.decode("aHR0cHM6Ly93d3cueW91dHViZS5jb20vd2F0Y2g/dj1kUXc0dzlXZ1hjUQ=="),
    xdate = function() return os.date("%B %d, %Y") end,
}

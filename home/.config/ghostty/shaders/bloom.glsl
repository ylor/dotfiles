...
// A golden spiral gives the halo an even radial shape with few samples.
// It preserves the source hue and adds no phosphor tint.

const float BLOOM_THRESHOLD = 0.01;
const float BLOOM_KNEE = 0.16;
const float BLOOM_STRENGTH = 0.36;
